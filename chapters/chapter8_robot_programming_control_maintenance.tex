...
\subsection{ระบบพิกัดในหุ่นยนต์อุตสาหกรรม}

\subsubsection{เหตุผลที่ต้องมีหลายระบบพิกัด}
...
\subsubsection{Joint Coordinate System}
...
\subsubsection{World หรือ Base Coordinate System}
...
\subsubsection{Tool Coordinate System และ Tool Center Point}
...
\subsubsection{User Coordinate System หรือ Work Object}
...
\subsubsection{การแปลงกรอบอ้างอิง}
...
\subsection{วิธีการสอนตำแหน่งหุ่นยนต์}

\subsubsection{Online Teaching ด้วย Teach Pendant}
...
\subsubsection{Lead-through Programming}
...
\subsubsection{Offline Programming}
...
\subsubsection{การกำหนดคุณภาพของจุดสอน}
...
\subsection{Motion Commands และการวางแผนเส้นทาง}

\subsubsection{ความแตกต่างระหว่าง Path และ Trajectory}
...
\subsubsection{Linear Motion: LIN}
...
\subsubsection{Circular Motion: CIRC/ARC}
...
\subsubsection{Blending, Zone และ CNT}
...
\subsubsection{ปัจจัยที่มีผลต่อ Path Planning}
...
\subsection{โครงสร้างโปรแกรมหุ่นยนต์เบื้องต้น}

\subsubsection{องค์ประกอบของโปรแกรมที่อ่านและบำรุงรักษาได้}
...
\subsubsection{ตัวอย่างโปรแกรม Pick and Place แบบ FANUC TP-like}
...
\subsubsection{ลำดับ Handshake กับ PLC}
...
\subsubsection{โครงสร้างควบคุมการไหล}
...
\subsubsection{ตัวอย่างโปรแกรมวางชิ้นงาน 2 × 5 ช่องแบบ Pseudocode}
...
\subsubsection{การจัดการ Timeout และ Fault}
...
\subsubsection{การตรวจสอบโปรแกรมก่อนใช้งานจริง}
...
\subsection{การบำรุงรักษาหุ่นยนต์อุตสาหกรรม}

\subsubsection{เป้าหมายของการบำรุงรักษา}
...
\subsubsection{หลักการสร้างแผน PM}
...
\subsubsection{การตรวจ Bolt และการใช้ Torque}
...
\subsubsection{Encoder Backup Battery และข้อมูลตำแหน่ง}
...
\subsubsection{Calibration และ Mastering}
...
\subsubsection{Zero Position และ Mastering Marks}
...
\subsubsection{การทวนสอบหลังซ่อมบำรุง}
...
\subsubsection{ตัวชี้วัดด้านการบำรุงรักษา}
...
\subsection{การแก้ไขปัญหาเบื้องต้น}

\subsubsection{หลักการ Troubleshooting}
...
\subsubsection{การอ่าน Alarm อย่างเป็นระบบ}
...
\subsection{ความปลอดภัยในการทำงานกับหุ่นยนต์}

\subsubsection{กรอบมาตรฐานที่เกี่ยวข้อง}
...
\subsubsection{ลำดับชั้นการลดความเสี่ยง}
...
\subsubsection{Operating Modes และการสอน}
...
\subsubsection{Warning Zone และ Protective Zone}
...
\subsubsection{LOTO สำหรับงานบำรุงรักษา}
...
\subsection{เปรียบเทียบภาษาโปรแกรมและซอฟต์แวร์จากผู้ผลิต}
...
\subsubsection{แผนภาพหรือชุดทดลอง}
...
\subsubsection{การเปรียบเทียบผลจริงกับทฤษฎีหรือแบบจำลอง}
...
\subsubsection{“จุดปลายเหมือนกัน จึงใช้ PTP หรือ LIN ก็เหมือนกัน”}
...
\subsubsection{“TCP คือปลายโลหะของ Tool เสมอ”}
...
\subsubsection{“User Frame เปลี่ยนแล้วทุกจุดจะถูกต้องโดยอัตโนมัติ”}
...
\subsubsection{“CNT 100 หมายถึงหุ่นยนต์ผ่านจุดด้วยความเร็วสูงสุดเสมอ”}
...
\subsubsection{“Simulation ไม่ชน แปลว่าระบบจริงไม่ชน”}
...
\subsubsection{“Emergency Stop ใช้แทน LOTO ได้”}
...
\subsubsection{“Alarm หายหลัง Reset แปลว่าปัญหาจบแล้ว”}
...
\subsubsection{“ต้องเติม Grease ทุก 3 เดือนสำหรับหุ่นยนต์ทุกตัว”}
...
\subsubsection{“เปลี่ยน Servo Motor แล้วสอน TCP ใหม่ก็เพียงพอ”}
...
\subsubsection{“Cobot ปลอดภัยโดยไม่ต้องมีการประเมินความเสี่ยง”}
...
\subsubsection{งานหยิบวางจาก Conveyor}
...
\subsubsection{งาน Machine Tending}
...
\subsubsection{งานพ่นสีหรือเดินกาว}
...
\subsubsection{การบำรุงรักษาเชิงคาดการณ์}
...
\subsection{แนวคำตอบสำหรับผู้สอน}
